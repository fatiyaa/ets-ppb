...
class DB {
  ...
  Future<void> addNote(String title, String desc, String imageUrl) async {
    final isar = await db;
    Note note = Note(title: title, note: desc, imageUrl: imageUrl);
  ...
  Future<void> updateNote(
    ...
    final isar = await db;
    Note note = Note(id: id, title: title, note: desc, imageUrl: imageUrl);
    await isar.writeTxn(() => isar.notes.put(note));
  }
}
